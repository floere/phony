...
Phony.define do
  ...
  country '359',
          trunk('0') |
          match(/^(2)\d{7}$/) >> split(7)  | # Sofia
          match(/^(30)\d{5}$/) >> split(5) |
          match(/^(30)\d{6}$/) >> split(6) |
          match(/^(31)\d{5}$/) >> split(5) |
          match(/^(31)\d{6}$/) >> split(6) |
          match(/^(32)\d{6}$/) >> split(6) |
          match(/^(33)\d{5}$/) >> split(5) |
          match(/^(33)\d{6}$/) >> split(6) |
          match(/^(34)\d{6}$/) >> split(6) |
          match(/^(35)\d{6}$/) >> split(6) |
          match(/^(36)\d{5}$/) >> split(5) |
          match(/^(36)\d{6}$/) >> split(6) |
          match(/^(37)\d{5}$/) >> split(5) |
          match(/^(37)\d{6}$/) >> split(6) |
          match(/^(38)\d{6}$/) >> split(6) |
          match(/^(39)\d{5}$/) >> split(5) |
          match(/^(39)\d{6}$/) >> split(6) |
          match(/^(41)\d{6}$/) >> split(6) |
          match(/^(41)\d{5}$/) >> split(5) |
          match(/^(42)\d{6}$/) >> split(6) |
          match(/^(43\d)\d{5}$/) >> split(5) |
          match(/^(44)\d{6}$/) >> split(6) |
          match(/^(45)\d{5}$/) >> split(5) |
          match(/^(45)\d{6}$/) >> split(6) |
          match(/^(46)\d{6}$/) >> split(6) |
          match(/^(47)\d{5}$/) >> split(5) |
          match(/^(47)\d{6}$/) >> split(6) |
          match(/^(51)\d{5}$/) >> split(5) |
          match(/^(51)\d{6}$/) >> split(6) |
          match(/^(52)\d{6}$/) >> split(6) |
          match(/^(53)\d{5}$/) >> split(5) |
          match(/^(53)\d{6}$/) >> split(6) |
          match(/^(54)\d{6}$/) >> split(6) |
          match(/^(55)\d{5}$/) >> split(5) |
          match(/^(55)\d{6}$/) >> split(6) |
          match(/^(56)\d{6}$/) >> split(6) |
          match(/^(57)\d{5}$/) >> split(5) |
          match(/^(57)\d{6}$/) >> split(6) |
          match(/^(58)\d{6}$/) >> split(6) |
          match(/^(59)\d{5}$/) >> split(5) |
          match(/^(59)\d{6}$/) >> split(6) |
          match(/^(60)\d{5}$/) >> split(5) |
          match(/^(60)\d{6}$/) >> split(6) |
          match(/^(61)\d{5}$/) >> split(5) |
          match(/^(61)\d{6}$/) >> split(6) |
          match(/^(62)\d{6}$/) >> split(6) |
          match(/^(63)\d{5}$/) >> split(5) |
          match(/^(63)\d{6}$/) >> split(6) |
          match(/^(64)\d{6}$/) >> split(6) |
          match(/^(65)\d{5}$/) >> split(5) |
          match(/^(65)\d{6}$/) >> split(6) |
          match(/^(66)\d{5}$/) >> split(5) |
          match(/^(66)\d{6}$/) >> split(6) |
          match(/^(68)\d{6}$/) >> split(6) |
          match(/^(69)\d{5}$/) >> split(5) |
          match(/^(69)\d{6}$/) >> split(6) |
          match(/^(700)\d{5}$/) >> split(5) |
          match(/^(701)\d{4}$/) >> split(4) |
          match(/^(701)\d{5}$/) >> split(5) |
          match(/^(702)\d{4}$/) >> split(4) |
          match(/^(702)\d{5}$/) >> split(5) |
          match(/^(703)\d{4}$/) >> split(4) |
          match(/^(703)\d{5}$/) >> split(5) |
          match(/^(704)\d{4}$/) >> split(4) |
          match(/^(704)\d{5}$/) >> split(5) |
          match(/^(705)\d{4}$/) >> split(4) |
          match(/^(705)\d{5}$/) >> split(5) |
          match(/^(706)\d{4}$/) >> split(4) |
          match(/^(706)\d{5}$/) >> split(5) |
          match(/^(707)\d{4}$/) >> split(4) |
          match(/^(707)\d{5}$/) >> split(5) |
          match(/^(708)\d{4}$/) >> split(4) |
          match(/^(708)\d{5}$/) >> split(5) |
          match(/^(709)\d{4}$/) >> split(4) |
          match(/^(709)\d{5}$/) >> split(5) |
          match(/^(71)\d{5}$/) >> split(5) |
          match(/^(71)\d{6}$/) >> split(6) |
          match(/^(72)\d{5}$/) >> split(5) |
          match(/^(72)\d{6}$/) >> split(6) |
          match(/^(73)\d{6}$/) >> split(6) |
          match(/^(74)\d{5}$/) >> split(5) |
          match(/^(74)\d{6}$/) >> split(6) |
          match(/^(75)\d{5}$/) >> split(5) |
          match(/^(75)\d{6}$/) >> split(6) |
          match(/^(76)\d{6}$/) >> split(6) |
          match(/^(77)\d{5}$/) >> split(5) |
          match(/^(77)\d{6}$/) >> split(6) |
          match(/^(78)\d{6}$/) >> split(6) |
          match(/^(79)\d{6}$/) >> split(6) |
          match(/^(80\d)\d{5}$/) >> split(5) |
          match(/^(81)\d{5}$/) >> split(5) |
          match(/^(81)\d{6}$/) >> split(6) |
          match(/^(82)\d{6}$/) >> split(6) |
          match(/^(84)\d{6}$/) >> split(6) |
          match(/^(86)\d{6}$/) >> split(6) |
          match(/^(87)\d{7}$/) >> split(7) |
          match(/^(88)\d{7}$/) >> split(7) |
          match(/^(89)\d{7}$/) >> split(7) |
          match(/^(90)\d{6}$/) >> split(6) |
          match(/^(91)\d{5}$/) >> split(5) |
          match(/^(91)\d{6}$/) >> split(6) |
          match(/^(92)\d{6}$/) >> split(6) |
          match(/^(93)\d{5}$/) >> split(5) |
          match(/^(93)\d{6}$/) >> split(6) |
          match(/^(94)\d{6}$/) >> split(6) |
          match(/^(93)\d{5}$/) >> split(5) |
          match(/^(93)\d{6}$/) >> split(6) |
          match(/^(94)\d{6}$/) >> split(6) |
          match(/^(95)\d{5}$/) >> split(5) |
          match(/^(95)\d{6}$/) >> split(6) |
          match(/^(96)\d{6}$/) >> split(6) |
          match(/^(97)\d{5}$/) >> split(5) |
          match(/^(97)\d{6}$/) >> split(6) |
          match(/^(98\d)\d{6}$/) >> split(6) |
          match(/^(99\d)\d{6}$/) >> split(6)
