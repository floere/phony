...
describe Phony::CountryCodes do
  ...
  describe '#plausible?' do
    it 'raises an error on a too long ccc' do
      ...
      end.to raise_error(ArgumentError, %{The provided ccc option is too long and includes more than a cc ('1') and ndc ('868'). It also includes '123'.})
    end
  end
