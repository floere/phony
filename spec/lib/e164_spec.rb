...
describe E164 do
  ...
  describe "split" do
    it "should handle austrian numbers" do
      E164.split('43198110').should == ['43', '1', '981', '10']
    end
    ...
    it "should handle US numbers" do
      E164.split('15551115511').should == ['1', '555', '111', '55', '11']
    end
  ...
  describe "formatted" do
    describe "default" do
      ...
      it "should format austrian numbers" do
        E164.formatted('43198110').should == '+43 1 981 10'
      end
    end
    describe "international" do
      it "should format austrian numbers" do
        E164.formatted('43198110', :format => :international).should == '+43 1 981 10'
      end
      it "should format austrian numbers" do
        E164.formatted('43198110', :format => :international_absolute).should == '+43 1 981 10'
      end
      it "should format french numbers" do
        E164.formatted('33142278186', :format => :+).should == '+33 1 42 27 81 86'
      end
      it "should format austrian numbers" do
        E164.formatted('43198110', :format => :international_relative).should == '0043 1 981 10'
      end
    end
    describe "national" do
      ...
      it "should format austrian numbers" do
        E164.formatted('43198110', :format => :national).should == '01 981 10'
      end
    end
    describe "local" do
      it "should format swiss numbers" do
