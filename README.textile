...
E164 numbers are international numbers with a country dial prefix, usually an area code and a subscriber number. For example, the Australia number number @+61 412 345 678@ can be broken down into the following components:
